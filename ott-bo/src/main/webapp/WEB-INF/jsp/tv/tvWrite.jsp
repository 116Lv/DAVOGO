...
<div class="container-fluid">
    ...
    <form id="tvForm" action="/tv/save.do" method="post" enctype="multipart/form-data">
    <!-- start page title -->
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
            	<div class="page-title-right">
            		<a href="<c:url value="/tv.do"/>" class="btn btn-primary btn-sm">목록</a>
            		<button type="submit" class="btn btn-primary btn-sm">저장</button>
            	</div>
                <h4 class="page-title">TV 등록/수정</h4>
            </div>
        </div>
    </div>     
    <!-- end page title -->
    	...
    	<div class="center">
    		<div class="left">
	    		...
	    		<input type="text" placeholder="프로그램명" name="tv_name" id="tv_name" value="${item.mediaName}" required>
	    		...
	    		<input type="text" placeholder="출연진명" name="actor" id="actor" value="${item.actor}" required>
	    		...
	    		<input type="text" placeholder="채널" name="channel" id="channel" value="${item.channel}" required>
	    		...
	    		<input type="text" placeholder="방송횟수" name="episode" id="episode" value="${item.episode}" required>
	    		...
	    		<textarea type="text" placeholder="간단한 tv정보 입력" name="introduce" id="introduce" required>${item.introduce}</textarea>
	    		
	    		<label for="period"><b>방송시작</b></label>
	    		<input name="period" id="period" type="text" placeholder="날짜 입력..." value="${item.period}"/>
			   	<script>
