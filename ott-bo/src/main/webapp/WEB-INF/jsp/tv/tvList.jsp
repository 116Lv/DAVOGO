	    ...
	    <div class="col-12">
		    <div class="card">
			    <div class="card-body">
				    ...
				    <form id="bannerSearchForm" name="bannerSearchForm" class="mb-3" action="/tv.do" method="">
						    	...
						    	<c:when test="${not empty list}">
							    	...
							    	<tr>
							    		...
							    		<td class="text-center">
											...
											<a class="action-icon text-info" href="/tv/edit.do?media_id=${item.mediaId}" title="수정하기">
