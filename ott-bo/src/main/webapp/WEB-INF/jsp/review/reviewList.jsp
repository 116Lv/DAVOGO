	    ...
	    <div class="col-12">
		    <div class="card">
			    <div class="card-body">
				    ...
				    <form id="reviewSearchForm" name="reviewSearchForm" class="mb-3" action="/review.do">
						...
						<div class="collapse show" id="searchCollapse">
							<div class="form-group row">
								<div class="col">
									...
									<input type="text" id="searchText" name="searchText" class="form-control" value="${searchParams.searchText}" placeholder="컨텐츠코드 / 평가SEQ / 작성자 등">
								</div>
							</div>
						</div>
						    	...
						    	<c:when test="${not empty list}">
							    	...
							    	<tr>
							    		...
							    		<td class="text-center">
											<a class="action-icon text-secondary" href="/review/view.do?review_id=${item.reviewId}" title="상세보기">
