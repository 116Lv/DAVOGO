            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="<c:url value="/comment.do"/>">코멘트</a></li>
                        <li class="breadcrumb-item active">코멘트 목록</li>
                    </ol>
                </div>
                <h4 class="page-title">코멘트 관리</h4>
            </div>
        </div>
    </div>     
    <!-- end page title --> 
	    ...
	    <div class="col-12">
		    <div class="card">
			    <div class="card-body">
				    ...
				    <form id="commentSearchForm" name="commentSearchForm" class="mb-3" action="/comment.do">
