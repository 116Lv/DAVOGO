            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="<c:url value="/user.do"/>">고객관리</a></li>
                        <li class="breadcrumb-item active">고객 목록</li>
                    </ol>
                </div>
                <h4 class="page-title">고객관리</h4>
            </div>
        </div>
    </div>     
    <!-- end page title --> 
	    ...
	    <div class="col-12">
		    <div class="card">
			    <div class="card-body">
				    ...
				    <form id="bannerSearchForm" name="bannerSearchForm" class="mb-3" action="/user.do">
