            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="<c:url value="/review/list.do"/>">리뷰</a></li>
	    ...
	    <div class="col-12">
		    <div class="card">
			    <div class="card-body">
				    ...
				    <form id="reviewSearchForm" name="reviewSearchForm" class="mb-3" action="/review/list.do">
						...
						<div class="collapse show" id="searchCollapse">
							<div class="form-group row">
								<div class="col">
									...
									<input type="text" id="searchText" name="searchText" class="form-control" value="${searchParams.searchText}" placeholder="리뷰번호 / 게임ID / 작성자">
								</div>
							</div>
						</div>
						...
						<div class="row mt-2">
							<div class="col-sm-6 mb-2">
					            <select id="orderColumn" name="orderColumn" class="form-select-sm me-1" onchange="searchList(1);">
					        		<option value="REVIEWID" <c:if test="${searchParams.orderColumn == 'REVIEWID'}">selected</c:if>>리뷰ID</option>
					        		<option value="WRITEDATE" <c:if test="${searchParams.orderColumn == 'WRITEDATE'}">selected</c:if>>작성일자</option>
					        	</select>
						...
						<table id="order-datatable" class="table table-centered table-hover w-100 nowrap dataTable">
						    <thead class="table-light">
						        <tr>
						            ...
						            <th scope="col">별점</th>
						            <th scope="col">비공개여부</th>
						            <th scope="col" class="text-center">비공개사유</th>
						        </tr>
						    </thead>
						    <tbody>
						    <c:choose>
						    	<c:when test="${not empty list}">
							    	...
							    	<tr>
							    		...
							    		<td class="text-center">
											<a class="action-icon text-secondary" href="/review/view.do?itemCode=${item.itemCode}" title="상세보기">
										    	<i class="mdi mdi-eye"></i>
											</a>
											<a class="action-icon text-info" href="/review/edit.do?itemCode=${item.itemCode}">
